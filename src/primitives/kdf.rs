...
///
/// `dh_output` is the 32-byte X25519 DH output (the EC root step is classical
/// DH-only; post-quantum material enters at the message-key layer, not here).
pub fn kdf_rk(root_key: &RootKey, dh_output: &[u8; 32]) -> RootKeyOutput {
